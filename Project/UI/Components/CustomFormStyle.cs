...
namespace CustomDesign.Components
{
    public partial class CustomFormStyle : Component
    {
        ...
        [Description("Цвет границы формы")]
        public Color FormBorderColor { get; set; } = Color.White;
        ...
        #endregion
        #region -- Поля --
        private Dictionary<fStyle, CustomStyle> StylesDictionary; // Словарь вида: <Стиль из набора, Объект стиля с параметрами>
        private CustomStyle CurrentStyle; // Актуальный стиль, класс с его параметрамы
        ...
        {
            StylesDictionary = new Dictionary<fStyle, CustomStyle>();
            ...
            StylesDictionary.Add(fStyle.SimpleDark,
                new CustomStyle()
                {
                    ...
                    FormBorderColor = FlatColors.PurpleDark,
        ...
        private void SaveNoneStyleConfig()
        {
            ...
            {
                CustomStyle NoneStyle = StylesDictionary[fStyle.None];
        ...
        private void Apply()
        {
            ...
            //Form.Move += Form_DrawBorder;
            //Form.Invalidated += Form_DrawBorder;
            //Form.ResizeEnd += Form_DrawBorder;
            //Form.MouseUp += Form_DrawBorder;
        }
        ...
        private void SetStyle(fStyle Style)
        {
            ...
            FormBorderColor = CurrentStyle.FormBorderColor;
        ...
        private void Form_DrawBorder(object sender, EventArgs e)
        {
            /*BufferedGraphicsContext context = new BufferedGraphicsContext();
            context.MaximumBuffer = Screen.PrimaryScreen.Bounds.Size;
            Graphics target = Graphics.FromHwnd(IntPtr.Zero);
            BufferedGraphics bg = context.Allocate(Form.Handle, Screen.PrimaryScreen.Bounds);
            bg.Graphics.DrawRectangle(new Pen(Color.FromArgb(200, Color.Blue)), Form.Location.X - 1, Form.Location.Y - 1, rectBorder.Width + 2, rectBorder.Height + 2);
            bg.Graphics.DrawRectangle(new Pen(Color.FromArgb(150, Color.Blue)), Form.Location.X - 2, Form.Location.Y - 2, rectBorder.Width + 4, rectBorder.Height + 4);
            bg.Graphics.DrawRectangle(new Pen(Color.FromArgb(100, Color.Blue)), Form.Location.X - 3, Form.Location.Y - 3, rectBorder.Width + 6, rectBorder.Height + 6);
            bg.Graphics.DrawRectangle(new Pen(Color.FromArgb(50, Color.Blue)), Form.Location.X - 4, Form.Location.Y - 4, rectBorder.Width + 8, rectBorder.Height + 8);
            bg.Graphics.DrawRectangle(new Pen(Color.FromArgb(25, Color.Blue)), Form.Location.X - 5, Form.Location.Y - 5, rectBorder.Width + 10, rectBorder.Height + 10);
            bg.Render();*/
            Graphics target = Graphics.FromHwnd(IntPtr.Zero);
            target.DrawRectangle(new Pen(Color.FromArgb(200, Color.Blue)), Form.Location.X - 1, Form.Location.Y - 1, rectBorder.Width + 2, rectBorder.Height + 2);
            target.DrawRectangle(new Pen(Color.FromArgb(150, Color.Blue)), Form.Location.X - 2, Form.Location.Y - 2, rectBorder.Width + 4, rectBorder.Height + 4);
            target.DrawRectangle(new Pen(Color.FromArgb(100, Color.Blue)), Form.Location.X - 3, Form.Location.Y - 3, rectBorder.Width + 6, rectBorder.Height + 6);
            target.DrawRectangle(new Pen(Color.FromArgb(50, Color.Blue)), Form.Location.X - 4, Form.Location.Y - 4, rectBorder.Width + 8, rectBorder.Height + 8);
            target.DrawRectangle(new Pen(Color.FromArgb(25, Color.Blue)), Form.Location.X - 5, Form.Location.Y - 5, rectBorder.Width + 10, rectBorder.Height + 10);
        ...
        private void DrawStyle(Graphics graph)
        {
            ...
            // Обводка / Border
            graph.DrawRectangle(new Pen(FormBorderColor), rectBorder);
            if (!IsDrawBorder)
            {
                IsDrawBorder = true;
                Graphics target = Graphics.FromHwnd(IntPtr.Zero);
                target.DrawRectangle(new Pen(Color.FromArgb(150, FormBorderColor)), Form.Location.X - 1, Form.Location.Y - 1, rectBorder.Width + 2, rectBorder.Height + 2);
                target.DrawRectangle(new Pen(Color.FromArgb(125, FormBorderColor)), Form.Location.X - 2, Form.Location.Y - 2, rectBorder.Width + 4, rectBorder.Height + 4);
                target.DrawRectangle(new Pen(Color.FromArgb(100, FormBorderColor)), Form.Location.X - 3, Form.Location.Y - 3, rectBorder.Width + 6, rectBorder.Height + 6);
                target.DrawRectangle(new Pen(Color.FromArgb(75, FormBorderColor)), Form.Location.X - 4, Form.Location.Y - 4, rectBorder.Width + 8, rectBorder.Height + 8);
                target.DrawRectangle(new Pen(Color.FromArgb(50, FormBorderColor)), Form.Location.X - 5, Form.Location.Y - 5, rectBorder.Width + 10, rectBorder.Height + 10);
            }
            #endregion
        }
